...
Implicit Type Promotion (Coercion)When performing arithmetic operations on mixed data types, C automatically upgrades the smaller data type to prevent precision loss. 
